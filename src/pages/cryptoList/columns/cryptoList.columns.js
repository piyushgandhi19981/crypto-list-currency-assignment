  ...
  return [
    {
      accessorFn: (row) => (
        <span style={{ paddingLeft: "1.6rem" }}>
          {cryptoReader.marketCapRank(row) || "-"}
        </span>
      ),
      header: "Rank",
    },
    ...
    {
      accessorFn: (row) =>
        `${sign}${cryptoReader.currentPrice(row)?.toLocaleString() ?? "N/A"}`,
      header: "Price",
    },
    {
      header: "Market Cap",
      accessorFn: (row) =>
        `${sign}${cryptoReader.marketCap(row)?.toLocaleString() ?? "N/A"}`,
    },
    {
      header: "24h Volume",
      accessorFn: (row) =>
        `${sign}${cryptoReader.totalVolume(row)?.toLocaleString() ?? "N/A"}`,
    },
    {
      header: "24h High",
      accessorFn: (row) =>
        `${sign}${cryptoReader.high24h(row)?.toLocaleString() ?? "N/A"}`,
    },
    {
      header: "24h Low",
      accessorFn: (row) =>
        `${sign}${cryptoReader.low24h(row)?.toLocaleString() ?? "N/A"}`,
    },
    {
